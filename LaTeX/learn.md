...
示例 [sample.tex](https://raw.githubusercontent.com/skylens/LinuxNote/master/LaTeX/sample.tex)
...
documentclass 可以是 article，report，book，letter ...

也可以是自定义的 `.sty` 文件

## userpackage

`\userpackage{xeCJK}` 引入 `xeCJK` 宏包
...
**只有 book 和 report 才有 chapter ，article 只有 section 一下**
